...
class StaticDriver:
    ...
    def __init__(self):
        ...
        """
        print('Opening file...')
        self.nc_file = Dataset('building_grid.nc', 'w', format='NETCDF4')
    ...
    def write_global_attributes(self):
        ...
        # --------------------------
        self.nc_file.title = 'Test PALM static driver'
        self.nc_file.author = 'Shaun Lowis'
        self.nc_file.institution = 'Bodeker Scientific'
    ...
    def define_variables(self):
        ...
        # Set topography
        # --------------
        nc_building_id[2, 2] = 1
        nc_building_id[2, 4] = 2
        nc_building_id[2, 6] = 3
        nc_building_id[4, 2] = 4
        nc_building_id[4, 4] = 5
        nc_building_id[4, 6] = 6
        nc_building_id[6, 2] = 7
        nc_building_id[6, 4] = 8
        nc_building_id[6, 6] = 9
